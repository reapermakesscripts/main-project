...
library.theme = {
    ...
    --[[theme.titlesize = 15
theme.sectorcolor = Color3.fromRGB(20,20,20)
theme.topcolor2 = Color3.fromRGB(15,15,15)

theme.background = "rbxassetid://2151741365"
theme.titlesize = 15

theme.accentcolor = Color3.fromRGB(62, 0, 171)
theme.accentcolor2 = Color3.fromRGB(86, 0, 232)

theme.topheight = 50
theme.bordercolor = Color3.fromRGB(40,40,40)
